...
export const metadata = {
  ...
  description: "Explore fresh perspectives on Another Way's Hero page.",
};
...
export default function Hero() {
  return (
    <section className="h-[90vh] md:h-[820px] grid place-content-center ">
      ...
      <div className=" font-extrabold text-4xl md:text-6xl mb-1 from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 ">Another Way</div>
      <div className="font-medium text-3xl md:text-5xl">Rethink. Reinvent. Redefine</div>
      </div>
      ...
      <Link href={"#"} className="font-bold text-sm mt-8 underline md:text-xl" >{"Explore the way ->"}</Link>
   {/*  */}
