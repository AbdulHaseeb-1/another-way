      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              "w-[90vw] md:w-[40vw] max-w-[400px] min-h-[50vh] max-h-[90vh] bg-white/80 dark:bg-neutral-950/80 border border-gray-200/50 dark:border-neutral-800/50 md:rounded-2xl relative z-50 flex flex-col overflow-y-auto backdrop-blur-lg shadow-xl",
              className
            )}
...
export const ModalFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-end p-4 bg-gray-100/80 dark:bg-neutral-900/80",
        className
      )}
    >
      {children}
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="absolute top-3 right-3 p-1 rounded-full hover:bg-gray-200/50 dark:hover:bg-neutral-700/50 transition-colors"
